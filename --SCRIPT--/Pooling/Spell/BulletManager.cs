...
public class BulletManager : MonoBehaviour
{
    ...
    [SerializeField] private BasicSpell pulledBulletPrefab;
    private Queue<BasicSpell> bulletPool = new Queue<BasicSpell>();
    public static int counter;
    public static BulletManager Instance { get; private set; } //questo è un singleton che non persiste se cambia scena (bisogna mettere don't destroy Onload)
    ...
    public void ReturnToPool(BasicSpell bullet)
    {
